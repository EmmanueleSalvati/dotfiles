...
#+begin_src emacs-lisp
  ...
  (setq org-base-path (expand-file-name
                       (cond ((string-equal system-name "MACC02DC2DEMD6N") "~/org")
                             ((string-equal system-name "Emmanueles-MacBook-Pro.local") "~/MEGA/org")
                             (t "~/MEGA/MEGA/org"))))
...
The following is difficult to understand, let me comment it out until I figure it out.
#+begin_src emacs-lisp
    ;; (use-package citar-org-roam
    ;;   :after (citar org-roam)
    ;;   :config (citar-org-roam-mode)
    ;;   :custom
    ;;   (org-cite-global-bibliography '("~/MEGA/org-roam/biblio.bib"))
    ;;   (org-cite-insert-processor 'citar)
    ;;   (org-cite-follow-processor 'citar)
    ;;   (org-cite-activate-processor 'citar)
    ;;   (citar-bibliography '("~/MEGA/org-roam/biblio.bib"))
    ;;   (citar-notes-paths '("~/MEGA/org-roam/reference"))
    ;;   (citar-symbols
...
#+begin_src emacs-lisp
  ...
  ;; citar has a function for inse  rting bibtex entries into a buffer, but none for
