...
Remove backup files from the same directory; instead, save them all in one spot
...
#+begin_src emacs-lisp
  ...
  (setq org-base-path (expand-file-name
                       (cond ((string-equal (system-name) "MACC02DC2DEMD6N") "~/org")
                             ...
                             ((string-equal (system-name) "yarnbaby")  "~/pCloudDrive/org")
                             ((string-equal (system-name) "yarnmonster") "~/pCloudDrive/org")
                             (t "~/MEGA/MEGA/org"))))
