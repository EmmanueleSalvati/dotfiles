...
* Pulsar
This is to temporarily highlight the current line
#+begin_src emacs-lisp
  (use-package pulsar
    :ensure t
    :bind
...
#+begin_src emacs-lisp
  (use-package golden-ratio
    ...
    (add-to-list 'golden-ratio-exclude-buffer-names "treemacs-mode"))
#+end_src
* Dired
...
#+begin_src emacs-lisp
  (use-package helpful
    ...
    (keymap-global-set "C-h x" #'helpful-commands)
    (keymap-global-set "C-h j" #'helpful-at-point)
...
#+begin_src emacs-lisp
  (setq org-base-path (expand-file-name "~/Nextcloud-stallone-yarnbaby/Documents/org"))
...
*** Capture Templates
TODO Complete this section by simplifying the literature note.
...
NOTE I don't think the citar-org-roam--create-capture-note exists anymore.
...
* Corfu mode
Implements completion at point.
